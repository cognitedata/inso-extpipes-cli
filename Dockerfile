...
ARG APP_NAME=inso_extpipes_cli # matching the pyproject.toml name
...
ENTRYPOINT ["poetry", "run", "extpipes-cli"]
...
# Entrypoint script - tailored to run extpipes-cli and await parameters
COPY ./docker-extpipes-entrypoint.sh /docker-entrypoint.sh
